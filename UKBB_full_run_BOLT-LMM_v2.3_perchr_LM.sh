...
/lustre/scratch115/projects/ukbiobank/Kostas/FULL_RELEASE/BOLT-LMM_v2.3/BOLT-LMM_v2.3/bolt \
        ...
        --fam=/lustre/scratch115/projects/ukbiobank/Kostas/FULL_RELEASE/BOLT-LMM_v2.3/VERSION_3/OP_hipknee/ukb9979_cal_chr1_v2_s488363_OP_hipknee_FixCol6.fam \
	...
	--exclude=/lustre/scratch115/projects/ukbiobank/Kostas/FULL_RELEASE/BOLT-LMM_v2.3/VERSION_3/SR/autosome_missing_gt_0.1.txt \
        --phenoFile=/lustre/scratch115/projects/ukbiobank_oa/OA_sample-file_v3_12042018/OP_hipknee_ukb9979_imp_chr1_v3_s487395_pheno-covar.sample \
        --phenoCol=OA_phenotype \
        --covarFile=/lustre/scratch115/projects/ukbiobank_oa/OA_sample-file_v3_12042018/OP_hipknee_ukb9979_imp_chr1_v3_s487395_pheno-covar.sample \
        --qCovarCol=PC{1:20} \
        ...
        --lmmForceNonInf \
        --numThreads=8 \
        --statsFile=/lustre/scratch115/projects/ukbiobank/Kostas/FULL_RELEASE/BOLT-LMM_v2.3/VERSION_3/OP_hipknee/chr${LSB_JOBINDEX}_bolt_OP_hipknee-OA.stats.gz \
        --bgenFile=/lustre/scratch115/projects/ukbiobank/FullRelease/Imputed/EGAD00010001474/ukb_imp_chr${LSB_JOBINDEX}_v3.bgen \
        --bgenMinINFO=0.3 \
        --sampleFile=/lustre/scratch115/projects/ukbiobank_oa/OA_sample-file_v3_12042018/OP_hipknee_ukb9979_imp_chr1_v3_s487395.sample \
        --statsFileBgenSnps=/lustre/scratch115/projects/ukbiobank/Kostas/FULL_RELEASE/BOLT-LMM_v2.3/VERSION_3/OP_hipknee/chr${LSB_JOBINDEX}_bolt_OP_hipknee-OA.bgen.stats.gz \
        --verboseStats
